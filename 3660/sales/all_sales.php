...
<body>
	...
	$sql = "SELECT Customer.first_name, Customer.last_name, Customer.phone_number, Vehicle._year, Vehicle.model, Vehicle._edition, sale_price, sale_date
	...
	{ 
		echo "<div class='sales_container'>";
		echo "<div class='item'>";
		echo "First Name";
		echo "</div>";
		echo "<div class='item'>";
